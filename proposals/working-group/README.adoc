...
* link:microprofile-working-group/microprofile-standalone-working-group-proposal.adoc[Independent MicroProfile Working Group]
* link:cloud-native-for-java-working-group/cloud-native-for-java-working-group-proposal.adoc[Combined Jakarta EE and MicroProfile Working Group]
