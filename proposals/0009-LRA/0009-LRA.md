...
* CDI-first approach to defining the lifecycle of LRAs and Compensators.
* [Source code for the proposed annoations:](lra-annotations/src/main/java/org/jboss/narayana/rts/lra/annotation).
