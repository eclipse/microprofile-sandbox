...
=== Original Proposal
See the original proposal https://github.com/phillip-kruger/microprofile-sandbox/blob/master/proposals/graphql/proposal/src/main/asciidoc/proposal.asciidoc[here]